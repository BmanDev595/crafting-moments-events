        ...
        <div className="border-t border-gray-200 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="https://facebook.com/" className="text-gray-400 hover:text-purple-600 transition duration-150">
              ...
              {/* Instagram */}
              <a href="https://instagram.com/" className="text-gray-400 hover:text-purple-600 transition duration-150">
              ...
              {/* Tiktok */}
              <a href="https://tiktok.com/" className="text-gray-400 hover:text-purple-600 transition duration-150">
